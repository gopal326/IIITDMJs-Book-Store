		...
		<div class="post" style="margin-left:100px">
			...
			<div class="entry">
				...
				<form action='process_addsubcategory.php' method='POST'>
							<h1 style="color:#0de7c4">ADD SUB-CATEGORY </h1>
							<br><br>
							<u style="color:#0de7c4">PARENT CATEGORY </u>
									<br>
										<select  name="parent">
											<?php
									...
									<br>
							<u style="color:#0de7c4">SUB-CATEGORY:</u>
									<br><br>
				...
				<form action='process_delsubcategory.php' method='POST'>
						...
						<b style="color:#0de7c4">DELETE SUB CATEGORY </b>						
							<br>
