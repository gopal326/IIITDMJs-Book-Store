...
CREATE TABLE IF NOT EXISTS `subcat` (
  ...
  FOREIGN KEY(parent_id) REFERENCES category(cat_id) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `book` (
  ...
  PRIMARY KEY (`b_id`),
  FOREIGN KEY(b_subcat) REFERENCES subcat(subcat_id) ON DELETE CASCADE ON UPDATE CASCADE
...
(1, 'admin', 'admin', 'admin123', 'Female', 'admin@gmail.com', '9859632561', 'Rajkot');
